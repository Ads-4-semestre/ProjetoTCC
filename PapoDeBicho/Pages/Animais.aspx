                    ...
                    <tr>
                        ...
                        <td class="auto-style6">
                            <div class="auto-style7" style="text-align: center">
                                ...
                                <br />
                                <br />
                            <asp:Button ID="btnAnimaisPendentes" runat="server" BackColor="#57CDD7" BorderColor="#235357" BorderStyle="None" Font-Bold="True" Font-Names="Arial" ForeColor="#666666" Width="100%" Height="70px" Text="Pendentes" OnClick="btnAnimaisPendentes_Click" />
                                <br />
                                <br />
                            <asp:Button ID="btnAnimaisCadastrados" runat="server" Text="Cadastrados" BackColor="#57CDD7" BorderColor="#235357" BorderStyle="None" Font-Bold="True" Font-Names="Arial" ForeColor="#666666" Width="100%" Height="70px" OnClick="btnAnimaisCadastrados_Click" />
                                <br />
                                <br />
                            <asp:Button ID="btnAnimaisBanidos" runat="server" Text="Banidos" BackColor="#57CDD7" BorderColor="#235357" BorderStyle="None" Font-Bold="True" Font-Names="Arial" ForeColor="#666666" Width="100%" Height="70px" OnClick="btnAnimaisBanidos_Click"/>
                            </div>
                            </td>
                    </tr>                            
                </table>   
