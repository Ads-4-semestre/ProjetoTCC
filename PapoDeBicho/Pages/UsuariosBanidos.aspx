<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsuariosBanidos.aspx.cs" Inherits="PapoDeBicho.Pages.UsuariosBanidos" %>
                    ...
                    <tr>
                        ...
                        <td class="auto-style6">
                            <div class="auto-style7">
                                <asp:Label ID="Label2" runat="server" Text="Usuários Banidos" Font-Size="20pt"></asp:Label>
                                <br />
                                <br />
                                <asp:GridView ID="gvUsuariosBanidos" runat="server" Width="100%">
                                </asp:GridView>
                                <br />
                                <br />
                                <br />
