...
namespace PapoDeBicho.Pages
{
    public partial class Animais : System.Web.UI.Page
    {
        ...
        protected void btnAnimaisPendentes_Click(object sender, EventArgs e)
        {
            Response.Redirect("AnimaisPendentes.aspx");
        }

        protected void btnAnimaisCadastrados_Click(object sender, EventArgs e)
        {
            Response.Redirect("AnimaisCadastrados.aspx");
        }

        protected void btnAnimaisBanidos_Click(object sender, EventArgs e)
        {
            Response.Redirect("AnimaisBanidos.aspx");
        }
    }
}