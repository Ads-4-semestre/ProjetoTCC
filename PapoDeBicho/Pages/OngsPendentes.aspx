<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OngsPendentes.aspx.cs" Inherits="PapoDeBicho.Pages.OngsPendentes" %>
        ...
        <table class="auto-style4">
                    <tr>
                        <td class="auto-style5">
                            ...
                            <br />
                            <br />
                            <asp:Button ID="btnAnimal" runat="server" Text="Animais" BackColor="#57CDD7" BorderColor="#235357" BorderStyle="None" Font-Bold="True" Font-Names="Arial" ForeColor="White" Width="228px" Height="56px" OnClick="btnAnimal_Click"/>
                            <br />
                            <br />
                        ...
                        <td class="auto-style6">
                            <div class="auto-style7">
                                <asp:Label ID="Label2" runat="server" Text="ONGs Pendentes" Font-Size="20pt"></asp:Label>
                                <br />
                                <br />
                                <asp:GridView ID="gvOngsPendentes" runat="server" Width="100%">
                                </asp:GridView>
                                <br />
                                <br />
                                <br />
