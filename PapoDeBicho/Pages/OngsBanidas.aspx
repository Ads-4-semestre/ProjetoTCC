<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OngsBanidas.aspx.cs" Inherits="PapoDeBicho.Pages.OngsBanidas" %>
                    ...
                    <tr>
                        ...
                        <td class="auto-style6">
                            <div class="auto-style7" style="text-align:center">
                                <asp:Label ID="Label2" runat="server" Text="ONGs Banidas" Font-Size="20pt"></asp:Label>
                                <br />
                                <br />
                                <asp:GridView ID="gvOngsBanidos" runat="server" Width="100%">
                                </asp:GridView>
                                <br />
                                <br />
                                <br />
